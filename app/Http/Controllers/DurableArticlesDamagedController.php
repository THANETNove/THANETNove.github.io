...
class DurableArticlesDamagedController extends Controller
{
    ...
    */
    ...
    public function store(Request $request)
    {
        ...
        //$data->group_id = $request['durable_group'];
        ...
        $data->status_damaged = $request['status_damaged'];
        $data->name_durable_articles_count = "1";
        $data->damaged_detail = $request['details_damaged'];
        $data->status = "0";
        $data->save();
